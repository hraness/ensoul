...
```sh
bunx skills add hraness/ensoul#v0.3.0 --skill ensoul
```
...
```sh
bun add --exact @hraness/ensoul@0.3.0
```
...
- `skills/ensoul/scripts/prepare-x-archive.ts` extracts a bounded set of account-authored public posts from an official local X archive without opening direct messages, address books, advertising data, or media.
