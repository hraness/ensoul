...
5. Create and push `v<VERSION>` only after that verification. The tag workflow re-runs the tests, compares the tagged npm tarball byte-for-byte, and creates an immutable GitHub Release.
